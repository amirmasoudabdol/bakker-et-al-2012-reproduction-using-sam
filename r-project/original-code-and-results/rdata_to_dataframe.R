...
ggsave("Figure 2/original_dataset_proportion_of_sig_results.png")

write.csv(cleanedProp, "Figure 2/original_proportion_of_sig_results_dataset.csv")
...
ggsave("Figure 2/original_dataset_effect_size_bias.png")

write.csv(es_df, "Figure 2/original_effect_size_bias_dataset.csv")
