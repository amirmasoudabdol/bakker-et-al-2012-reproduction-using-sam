    ...
    for (k in 1:nsim)
    {
      ...
      if (pL > alpha | esL < 0)
      {
        ...
        if (pL_2 > alpha | esL_2 < 0)
        {
          ...
          if ((pL_3_v1 > alpha | esL_3_v1 < 0) & (pL_3_v2 > alpha | esL_3_v2 < 0))
          {
            ...
            all_psL = c(pL, pL_2, pL_3_v1, pL_3_v2)
            all_esL = c(esL, esL_2, esL_3_v1, esL_3_v2)
      ...
      for (l in 1:mf)
      {
        ...
        if (p > alpha | esS < 0)
        {
          ...
          if (p_2 > alpha | es_2 < 0)
          {
            ...
            #> If NIETHER of the results where sig with postive effect
            if ((p_3_v1 > alpha | es_3_v1 < 0) &
                (p_3_v2 > alpha | es_3_v2 < 0))
            {
              #if non is significant select the best result
              all_ps = c(p, p_2, p_3_v1, p_3_v2)
              all_es = c(esS, es_2, es_3_v1, es_3_v2)
      ...
      if (length(which(esSQRP > 0)) > 0)
      {
        if (length(which(pSQRP < alpha & esSQRP > 0)) > 0)
        {
          ...
          catQRPAr[i, j, k, 4] = which(pSQRP < alpha &
                                         esSQRP > 0)[1]
        } else{
