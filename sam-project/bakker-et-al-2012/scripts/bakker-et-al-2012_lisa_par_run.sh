...
export STOPOS_POOL=bakker-et-al-2012_pool
...
FRODO_DIR=${PROJECT_DIR}/projects/bakker-et-al-2012
...
rm -rf ${TMPDIR}/bakker-et-al-2012
PROJECT_TMP_DIR=${TMPDIR}/bakker-et-al-2012
...
(
	...
	(
		...
		stopos next -p bakker-et-al-2012_pool
		...
		stopos remove -p bakker-et-al-2012_pool
