...
export STOPOS_POOL=bakker-et-al-2012-extended-no-qrp_pool
...
FRODO_DIR=${PROJECT_DIR}/projects/bakker-et-al-2012-extended-no-qrp
...
rm -rf ${TMPDIR}/bakker-et-al-2012-extended-no-qrp
PROJECT_TMP_DIR=${TMPDIR}/bakker-et-al-2012-extended-no-qrp
...
nply=bakker-et-al-2012-extended-no-qrp_nply
...
(
	...
	(
		...
		stopos next -p bakker-et-al-2012-extended-no-qrp_pool
		...
		stopos remove -p bakker-et-al-2012-extended-no-qrp_pool
