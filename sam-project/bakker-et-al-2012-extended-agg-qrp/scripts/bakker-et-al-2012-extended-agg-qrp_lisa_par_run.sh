...
export STOPOS_POOL=bakker-et-al-2012-extended-agg-qrp_pool
...
FRODO_DIR=${PROJECT_DIR}/projects/bakker-et-al-2012-extended-agg-qrp
...
rm -rf ${TMPDIR}/bakker-et-al-2012-extended-agg-qrp
PROJECT_TMP_DIR=${TMPDIR}/bakker-et-al-2012-extended-agg-qrp
...
nply=bakker-et-al-2012-extended-agg-qrp_nply
...
(
	...
	(
		...
		stopos next -p bakker-et-al-2012-extended-agg-qrp_pool
		...
		stopos remove -p bakker-et-al-2012-extended-agg-qrp_pool
